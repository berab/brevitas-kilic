...
class QuantWeightLeNet(Module):
    def __init__(self):
        ...
        self.conv1 = qnn.QuantConv2d(3, 6, 5, weight_bit_width=8)
        self.relu1 = nn.ReLU()
        self.conv2 = qnn.QuantConv2d(6, 16, 5, weight_bit_width=8)
        self.relu2 = nn.ReLU()
        ...
        self.relu4 = nn.ReLU()
        self.fc3   = qnn.QuantLinear(84, 10, bias=False, weight_bit_width=8)
